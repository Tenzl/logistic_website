...
import { postService, PostRequest } from '../services/postService'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (postId) {
        ...
        toast({
          title: "Success",
          description: "Post updated successfully! Returning to posts...",
        })
      } else {
        await postService.createPost(formData)
        toast({
          title: "Success",
          description: "Post created successfully! Returning to posts...",
        })
      }
