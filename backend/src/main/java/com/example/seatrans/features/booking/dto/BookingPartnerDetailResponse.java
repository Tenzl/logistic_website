...
@Data
@Builder
public class BookingPartnerDetailResponse {
    ...
    public static BookingPartnerDetailResponse from(BookingPartner partner) {
        return BookingPartnerDetailResponse.builder()
            .id(partner.getId())
