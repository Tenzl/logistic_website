...
import com.example.seatrans.features.user._customer.dto.CustomerDTO;
import com.example.seatrans.features.user._customer.model.Customer;
import com.example.seatrans.features.user.dto.EmployeeDTO;
...
public class EntityMapper {
    ...
    public ServiceTypeDTO toServiceTypeDTO(ServiceTypeEntity entity) {
        if (entity == null)
            return null;
        return new ServiceTypeDTO(entity.getId(), entity.getName(), entity.getDisplayName(), entity.getDescription(),
                true);
    }
    ...
    public ImageTypeDTO toImageTypeDTO(ImageTypeEntity entity) {
        if (entity == null)
            return null;
        return new ImageTypeDTO(entity.getId(), entity.getServiceType().getId(), entity.getServiceType().getName(),
                entity.getName(), entity.getDisplayName(), entity.getDescription(), entity.getRequiredImageCount(),
                true);
    }
    ...
    public PortDTO toPortDTO(Port entity) {
        if (entity == null)
            return null;
        return new PortDTO(entity.getId(), entity.getName(), entity.getProvince().getId(),
                entity.getProvince().getName(), true);
    }
