package com.example.seatrans.features.user._customer.controller;
...
import com.example.seatrans.features.user._customer.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<ApiResponse<List<CustomerDTO>>> getCustomersByMembershipLevel(
            @PathVariable MembershipLevel level) {
