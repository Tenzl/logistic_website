...
import com.example.seatrans.features.user.repository.RoleRepository;
...
public class UserService {
     ...
     * - If email belongs to a registered (non-guest) user: throw
     * DuplicateUserException.
     * - If email belongs to a guest: reuse and lightly refresh profile data.
     * - If email is new: create a guest with null username and a generated
     * password.
     */
