...
// */
// @Repository
// public interface CustomImageTypeRepository extends
// JpaRepository<CustomImageType, Long> {

// /**
// * Find all active types by service
// */
// List<CustomImageType>
// findByServiceTypeAndIsActiveTrueOrderByDisplayOrder(ServiceType serviceType);

// /**
// * Find all types by service (including inactive)
// */
// List<CustomImageType> findByServiceTypeOrderByDisplayOrder(ServiceType
// serviceType);

// /**
// * Find by service and code (unique)
// */
// Optional<CustomImageType> findByServiceTypeAndCode(ServiceType serviceType,
// String code);
...
// */
// Optional<CustomImageType>
// findFirstByServiceTypeOrderByDisplayOrderDesc(ServiceType serviceType);
// }
