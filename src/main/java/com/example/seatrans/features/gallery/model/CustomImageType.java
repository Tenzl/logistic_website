...
import com.example.seatrans.features.gallery.model.ServiceType;
...
@Table(name = "custom_image_types", indexes = {
    ...
    @Index(name = "idx_service_code", columnList = "service_type,code", unique = true)
})
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class CustomImageType {
    ...
    private String code; // e.g., "GALLERY", "CERTIFICATES", "EQUIPMENT", "OPERATIONS", "CUSTOM_1"
