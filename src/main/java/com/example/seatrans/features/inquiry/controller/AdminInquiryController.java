...
public class AdminInquiryController {
    ...
    @GetMapping("/inquiries/{serviceSlug}")
    ...
    @DeleteMapping("/inquiries/{serviceSlug}/{id}")
    ...
    @PatchMapping("/inquiries/{serviceSlug}/{id}/form")
    ...
    @PatchMapping("/inquiries/{serviceSlug}/{id}/hours")
