...
/**
 * Total Logistics Inquiry Detail
 * Currently reuses the freight-forwarding field set
 */
@Entity
@Table(name = "total_logistics_inquiries", indexes = {
...
@AllArgsConstructor
@Builder
public class TotalLogisticInquiry {
