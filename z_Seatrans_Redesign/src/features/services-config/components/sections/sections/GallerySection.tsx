...
export function GallerySection({
  ...
  return (
    <section id="service-gallery" ref={sectionRef} className="bg-background py-16 md:py-24">
      <div className="container">
        <div className="text-center mb-12">
          <h2 className={isVisible ? 'fade-rise' : 'opacity-0'}>{gallery.sectionTitle}</h2>
          <p
                    ...
                    <DialogContent className="max-w-4xl">
                      ...
                      <div className="mt-4 space-y-2">
                        ...
                        <div className="flex gap-2">
                          <Badge variant="secondary">{image.imageTypeName}</Badge>
                          <Badge variant="secondary">{image.provinceName}</Badge>
                          <Badge variant="outline">{image.serviceTypeName}</Badge>
                        </div>
                      </div>
                    </DialogContent>
                  </Dialog>
