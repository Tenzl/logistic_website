...
(function () {
    ...
    const mont ong = 'January February March April May June July August September October November December'.split(' ');
    ...
    const getDateTime = (editor, fmt, date = new Date()) => {
        ...
        fmt = fmt.replace('%B', '' + editor.translate(mont ong[date.getMonth()]));
